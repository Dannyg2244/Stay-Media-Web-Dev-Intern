...
export const HeaderNew = () => {
    ...
    return (
            ...
            >
                ...
                <nav>
                    <HStack spacing="6" color="black">
                        ...
                        <Link rel="noFollow" to="/new-event"><Text color="black" as="p" fontStyle="normal" fontSize="14" fontFamily="serif">News & Events</Text></Link>
        ...
        <Box pl="20" pr="20"  top="44" left="0.5" position="absolute" color="black" w="100%" >
                <Text as="h1" fontSize="36" fontFamily="sans-serif" fontWeight="extrabold">NEWS & EVENTS</Text>
                <HStack ><Text color="#D9D9D9">Home> </Text> <Text color="black">News & Events</Text></HStack>
        </Box>
        </Box>
    )
}